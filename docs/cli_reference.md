...
└── api/
    ...
    ├── routers.py         # Router registration (edit to add your routers)
...
Next steps:
  1. Edit api/routers.py to add your CRUD routers
...
def create_users_router(db: Database) -> APIRouter:
    ...
    """
    # TODO: Import your Users model and uncomment below
...
- Generating boilerplate router code
